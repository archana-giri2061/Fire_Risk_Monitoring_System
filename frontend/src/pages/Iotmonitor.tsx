          ...
          {isMobile ? (
            ...
            <>
              <div style={card()}>
                ...
                {devices.length === 0 ? (
                  <div style={{ textAlign: "center", padding: "28px 0", color: "rgba(255,255,255,0.3)", fontSize: 13 }}>No sensor data. Send data via POST /api/sensor/ingest</div>
                ) : (
...
// ── Demo devices (fallback when no real sensor data) ───────────────────────
